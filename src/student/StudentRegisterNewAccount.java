...
public class StudentRegisterNewAccount implements ActionListener {
					...
					JButton b1, b2;
					public StudentRegisterNewAccount() {
								...
								l1 = new JLabel("YOU ARE CREATING NEW ACCOUNT AS STUDENT");
			...
			public void actionPerformed(ActionEvent e) {
						...
						if(e.getSource()==b1) {
							...
							studentDetails.saveStudentData(this);
								f.dispose();
									}
							}
						if(e.getSource()==b2) {
